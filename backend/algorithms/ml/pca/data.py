"""Data loading and preparation for PCA."""
...
def load_digits_data() -> Dict[str, Any]:
    """Load and prepare the digits dataset for PCA dimensionality reduction.

    The digits dataset contains 1,797 samples of 8x8 grayscale images of handwritten
    digits (0-9). Each image is represented as a 64-element feature vector, making it
    an excellent candidate for demonstrating PCA's dimensionality reduction capabilities.
...
def get_dataset_info() -> Dict[str, Any]:
    ...
    return {
        ...
        'description': 'Handwritten digits dataset (8x8 images) with 64 features per sample'
    }
