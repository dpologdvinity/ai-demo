"""Data loading and preparation for Lasso Regression."""

from typing import Dict, Any
from backend.utils.datasets import DatasetManager


def load_boston_data() -> Dict[str, Any]:
    """Load and prepare the California Housing dataset for Lasso Regression.
    ...
    is well-suited for demonstrating Lasso's feature selection capabilities as
    it contains features with varying importance levels.
