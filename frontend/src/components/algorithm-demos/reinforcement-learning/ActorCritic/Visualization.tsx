        ...
        <>
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <p>
                  ...
                  <br />
                  {result.parameters_used.hidden_size}
                </p>
                <p>
          ...
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <p className="text-sm text-blue-900 dark:text-blue-100">
              <strong>Interpretation:</strong> Actor-Critic combines policy gradient (actor) and
              value function (critic) methods. The actor learns to improve the policy, while the
              critic learns to estimate state values. This combined approach often learns faster
              and more stably than pure policy gradient methods.
            </p>
          </div>
        </>
      ) : (
