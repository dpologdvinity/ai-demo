        ...
        <>
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <p>
                  ...
                  <br />
                  {result.parameters_used.environment}
                </p>
                <p>
          ...
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <p className="text-sm text-blue-900 dark:text-blue-100">
              <strong>Interpretation:</strong> SARSA is an on-policy learning algorithm, meaning it
              learns from the actions it actually takes. The chart shows how the agent's performance
              improves as it discovers better policies. Unlike Q-Learning, SARSA considers the
              exploration actions during learning.
            </p>
          </div>
        </>
      ) : (
