        ...
        <>
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <p>
                  ...
                  <br />
                  {result.parameters_used.batch_size}
                </p>
                <p>
          ...
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <p className="text-sm text-blue-900 dark:text-blue-100">
              <strong>Interpretation:</strong> The chart shows how the agent's performance improves
              over training episodes. A general upward trend indicates the agent is learning to
              solve the CartPole task. Success rate is the percentage of episodes where the agent
              balanced the pole for the full episode duration.
            </p>
          </div>
        </>
      ) : (
