    ...
    <div className="grid gap-6 md:grid-cols-2">
      <Card>
        <CardHeader>
          ...
          <CardDescription>How Elastic Net works</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 p-3 bg-muted rounded-md">
            <p className="text-xs font-mono text-muted-foreground">
              Objective: minimize ||y - Xw||² + α·ρ·||w||₁ + α·(1-ρ)/2·||w||²
            </p>
            <p className="text-xs text-muted-foreground mt-2">
              where α controls overall regularization strength and ρ (l1_ratio) controls the L1/L2 mix
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground mt-4">
            <strong>Ridge vs Lasso vs Elastic Net:</strong> Ridge (L2) shrinks all coefficients but keeps all features.
            Lasso (L1) produces sparse solutions by setting some coefficients to zero.
            Elastic Net combines both, offering sparsity with stability for correlated features.
          </p>
        </CardContent>
      </Card>
    </div>
